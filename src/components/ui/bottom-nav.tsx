...
export function BottomNav({ pathname }: BottomNavProps) {
  ...
  return (
    <nav
      className="fixed inset-x-0 bottom-0 z-50 block border-t bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/90 border-border md:hidden safe-area-bottom"
      aria-label="Primary"
    >
