...
import { AccessiblePriceSlider } from "./accessible-price-slider";
...
export function SimpleFilters({ brands }: SimpleFiltersProps) {
  ...
  return (
    <aside
      className="space-y-4 p-6 bg-card rounded-2xl border shadow-soft"
        ...
        <div className="flex items-center gap-2">
          ...
          {getActiveFiltersCount() > 0 && (
            <Badge
              variant="secondary"
              className="text-xs"
              aria-label={`${getActiveFiltersCount()} active filter${getActiveFiltersCount() === 1 ? "" : "s"}`}
            >
          ...
          <AccordionContent className="space-y-4 pt-2">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Search
                  className="absolute left-3 top-2.5 h-3 w-3 text-muted-foreground"
                  aria-hidden="true"
                />
                <Input
                  id="brand-search"
                  ...
                  aria-describedby="brand-search-description"
                />
                <div id="brand-search-description" className="sr-only">
                  Type to filter the list of phone manufacturers
                </div>
              </div>
              <div
                className="max-h-32 overflow-y-auto space-y-1"
                role="group"
                aria-label="Phone manufacturers"
                aria-describedby="manufacturers-help"
              >
                <div id="manufacturers-help" className="sr-only">
                  Select one or more manufacturers to filter phones. Use
                  ...
                  >
                    ...
                    {brand._count?.phones && (
                      <span
                        ...
                        aria-label={`${brand._count.phones} phones available`}
                      >
                        ({brand._count.phones})
                      </span>
                    )}
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  className="h-3 w-3"
                  aria-describedby="5g-help"
                />
                <Label htmlFor="5g-support" className="text-xs cursor-pointer">
                  5G Support
                </Label>
                <div id="5g-help" className="sr-only">
                  Filter phones that support 5G networks
                </div>
              </div>
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  className="h-3 w-3"
                  aria-describedby="pta-help"
                />
                <Label
                  htmlFor="pta-approved"
                  className="text-xs cursor-pointer"
                >
                  PTA Approved
                </Label>
                <div id="pta-help" className="sr-only">
                  Filter phones approved by Pakistan Telecommunication Authority
                </div>
              </div>
            </div>
          </AccordionContent>
